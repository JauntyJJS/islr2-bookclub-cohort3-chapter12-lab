...
[`tidyclust::hier_clust`](https://emilhvitfeldt.github.io/tidyclust/reference/hier_clust.html) is used to do the hierarchical clustering. Here, we set the number of clusters to four and use the complete linkage method. It actually uses [`stats::hclust()`](https://rdrr.io/r/stats/hclust.html) and Euclidean distance under the hood.
